                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="company_profile" rows="5">{{(isset($data['results']->company_profile) ? $data['results']->company_profile : '')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="what_we_do" rows="5">{{(isset($data['results']->what_we_do) ? $data['results']->what_we_do : '')}}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="our_goals" rows="5">{{(isset($data['results']->our_goals) ? $data['results']->our_goals : '')}}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="our_mission" rows="5">{{(isset($data['results']->our_mission) ? $data['results']->our_mission : '')}}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="our_ethics" rows="5">{{(isset($data['results']->our_ethics) ? $data['results']->our_ethics : '')}}</textarea>
