         ...
         <div class="col-lg-5">
            <div class="trip-ad-content">
              ...
              <p> Make Reservations Online.</p>
               ...
               Your Total Sales commission will be paid to your Business Owners or Affiliate Wallet account between 2 to 7 days after sales. You can Cash Out Anywhere World Wide.</p>
               <p>Enter Details<br>
               Create <br>
               Publish and Share<br>
               Get Purchases and Reservation Notifications Right on Your Cell Phone.</p>
               <div class="trip-ad-btn">
                  <a href="{{url('/auth')}}" class="btn-blue btn-red">BOOK NOW</a>
               </div>
            </div>
         </div>
         <div class="col-lg-7">
