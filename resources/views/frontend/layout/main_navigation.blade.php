            ...
            <div class="header_menu">
                ...
                <nav class="navbar navbar-default navbar-sticky-function navbar-arrow">
                    <div class="logo pull-left">
                        <a href="{{url('/')}}"><img class="latest-logo" alt="Image" width="120" height="58"
                                src="{{asset(get_settings('logo'))}}"></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav" id="responsive-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a
                                            href="{{url('/businesses')}}/vehicles-ATV-bikes-boats-jetSkis">Vehicles-ATV-Bikes-Boats-JetSkis</a>
                                    </li>
                                    <li><a href="{{url('/businesses')}}/Adult Entertainment">Adult Entertainment</a>
                                    </li>
                                    <li><a href="{{url('/businesses')}}/Medical Marijuana & CBD">Medical Marijuana &
                                            CBD</a></li>
                                    ...
                                    <li><a href="{{url('/businesses')}}/Movie Theaters & Hotels">Movie Theaters &
                                            Hotels</a></li>
