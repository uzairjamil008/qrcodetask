      ...
      <div class="col-12">
         ...
         <div class="card">
            ...
            <div class="card-header border-bottom">
               ...
               <a class="btn btn-primary" href="{{url('admin/memberships')}}">Add Package</a>
               ...
               <table class="table dynamic_table font-weight-bold">
                  ...
                  @foreach($data['results'] as $key=>$value)
                     ...
                     <tr>
                        ...
                        <td>{{$value->commision_per_sale}}</td>
                         <td>
                     <div class="dropdown">
                     ...
                     <a class="dropdown-item" href="{{url('admin/memberships/'.$value->id )}}">
