...
class BusinessSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $userRoleId = DB::table('roles')->where('role_title', 'Business')->pluck('id')->first();
        ...
        $data = [
           ...
           'email_verified_at' => Carbon::now(),
            ...
            'facebook' => 'https://www.facebook.com/business1',
            'twitter' => 'https://twitter.com/business1',
            'instagram' => 'https://www.instagram.com/business1',
            'linkedin' => 'https://www.linkedin.com/in/business1',
