...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $userRoleId = DB::table('roles')->where('role_title', 'Admin')->pluck('id')->first();
        ...
        $data = [
            ...
            'facebook' => 'https://www.facebook.com/admin1',
            'twitter' => 'https://twitter.com/admin1',
            'instagram' => 'https://www.instagram.com/admin1',
